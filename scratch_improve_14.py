...
ArticleExtensions.GetWordCount(article)</div>
            ...
            <div class="concept-block">
                ...
                <p>An extension-method call can be understood as a call to the corresponding static method, with the object before the dot supplied as the first argument.</p>
                ...
                <pre><code class="language-csharp">if (article.Title.IsValidArticleTitle())
{
    Console.WriteLine("Valid title!");
            ...
            <div class="concept-block">
                ...
                <p>You can extend entire collections of objects. <code>IEnumerable&lt;T&gt;</code> is an interface implemented by many in-memory collections, including <code>List&lt;T&gt;</code> and arrays.</p>
...
int count = myArticles.CountPublished();</code></pre>
                ...
                <p>By extending <code>IEnumerable&lt;Article&gt;</code> instead of <code>List&lt;Article&gt;</code>, this method will automatically work on Lists, Arrays, HashSets, or any other in-memory enumerable collection of articles!</p>
            </div>
...
FindAll executes the condition</div>
            ...
            <div class="concept-block">
                ...
                <p>A large part of the LINQ API is provided through extension methods such as <code>Where</code>, <code>Select</code>, and <code>OrderBy</code>. These methods commonly accept lambda expressions to describe the operation.</p>
...
Important foundation for LINQ</div>
            ...
            <div class="concept-block">
                ...
                <div class="evolution-step">
                    ...
                    <p><strong>Fact:</strong> The original <code>Article</code> class is completely untouched. The method is declared in the static extension class, not in the original class.</p>
                </div>
                ...
                <div class="evolution-step">
                    ...
                    <pre><code class="language-csharp">class Article {
    public void Print() { Console.WriteLine("Instance Method"); }
}
// If an extension method Print() also exists, article.Print() prints "Instance Method".</code></pre>
                </div>
    ...
    public static bool IsPopular(this Article article) {
        return article.ViewCount > 1000;
            ...
            <details>
                ...
                <div>A large part of the LINQ API is provided through extension methods such as `Where`, `Select`, and `OrderBy`. These methods commonly accept lambda expressions to describe the operation.</div>
            </details>
