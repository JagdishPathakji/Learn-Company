...
INSERT IGNORE INTO USER_ROLE (user_id, role_id) VALUES (@author_id, 2); -- Author
INSERT IGNORE INTO USER_ROLE (user_id, role_id) VALUES (@editor_id, 3); -- Editor
INSERT IGNORE INTO USER_ROLE (user_id, role_id) VALUES (@reviewer_id, 1); -- Reviewer
