...
INSERT INTO ARTICLE (article_id, author_id) VALUES (@article1_id, @user1_id);

-- Insert Versions for this article
SET @version1_id = UUID_TO_BIN('BBBBBBBB-BBBB-BBBB-BBBB-BBBBBBBBBBBB', 1);
SET @version2_id = UUID_TO_BIN('CCCCCCCC-CCCC-CCCC-CCCC-CCCCCCCCCCCC', 1);

INSERT INTO ARTICLE_VERSION (version_id, article_id, version_number, title, status_id, created_by)
VALUES (@version1_id, @article1_id, 1, 'My First SQL Guide (Draft)', 1, @user1_id)

INSERT INTO ARTICLE_VERSION (version_id, article_id, version_number, title, stat)